...
const Agua = () => {
  ...
  useEffect(() => {
    const obtenerDatosAnteriores = async () => {
      const docRef = doc(db, "aguaMedidores", "usuario1");
  ...
  const confirmarYGuardar = async () => {
    const userDocRef = doc(db, "aguaMedidores", "usuario1");
    ...
    try {
      ...
      const historialRef = collection(db, "aguaMedidoresHistorial");
  ...
  return (
    <div className="container">
      ...
      <Link to="/historial-agua">Historial de agua</Link>
